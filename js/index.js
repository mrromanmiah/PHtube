...
//     div.innerHTML = `
//         <a onclick="handleVideos('${
//           category.category_id
//         }')" class="tab bg-[#25252526] font-medium rounded ${
...
//             <figure class="rounded-lg h-auto w-auto relative"><img class="h-48 w-96" src=${
//               videos?.thumbnail
//             }
//                     alt="image" />
//                     ${
...
//                         ${videos?.title}
//                     </h2>
//                     <p class="flex gap-2 text-[#171717B2] text-sm font-normal">${
